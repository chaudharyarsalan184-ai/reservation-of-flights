/**
 * Airport data for flight search - IATA code, name, city, country
 */
export const AIRPORTS = [
  ...
  // Turkey & Additional International
  ...
  { code: "SKD", name: "Samarkand International", city: "Samarkand", country: "Uzbekistan" },
