...
function buildBookingState(flight, from, to, departureDate, returnDate, passengers, tripType) {
                      ...
                      <FlightResultCard
                        ...
                        onBook={() => navigate('/booking', {
                          state: buildBookingState(
                            flight,
                            from || flight.outbound?.departureCode || 'JFK',
                            to || flight.outbound?.arrivalCode || 'SFO',
                            departureDate || '',
                            returnDate || '',
                            passengers || '1',
                            tripType || 'round-trip',
